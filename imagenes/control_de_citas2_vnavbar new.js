...
if (typeof(loc)=="undefined" || loc==""){
	...
	if (document.body&&document.body.innerHTML){
		...
		var ml=tt.match(/["']([^'"]*)control_de_citas2_vnavbar.js["']/i);
		if(ml && ml.length > 1) loc=ml[1];
	}
}
document.write("<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr>");
tr(false);
writeButton(loc+"../","elements_vnavbar.html","control_de_citas2_vnavbar_b1",114,30,"Inicio","",0);
writeButton(loc+"../","elements_vnavbar2.html","control_de_citas2_vnavbar_b2",114,30,"Nueva Cita","",0);
writeButton(loc+"../","elements_vnavbar3.html","control_de_citas2_vnavbar_b3",114,30,"Modificar Citas","",0);
writeButton(loc+"../","elements_vnavbar4.html","control_de_citas2_vnavbar_b4",114,30,"Búsqueda","",0);
writeButton(loc+"../","elements_vnavbar5.html","control_de_citas2_vnavbar_b5",114,30,"Administrar","",0);
writeButton(loc+"../","elements_vnavbar6.html","control_de_citas2_vnavbar_b6",114,30,"Seguridad","",0);
writeButton(loc+"../","elements_vnavbar7.html","control_de_citas2_vnavbar_b7",114,30,"Salir","",0);
tr(true);
