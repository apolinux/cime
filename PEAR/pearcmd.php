...
if ('/home/devel/Web/Percasoft/Clients/Cime/citas_medicas/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/home/devel/Web/Percasoft/Clients/Cime/citas_medicas/PEAR '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
